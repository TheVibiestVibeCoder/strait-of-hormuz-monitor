...
define('ALLOW_WEB_MANUAL_TRIGGER', env_int('ALLOW_WEB_MANUAL_TRIGGER', 1) === 1);
define('MANUAL_WEB_RUNTIME', env_int('MANUAL_WEB_RUNTIME', 20));
define('AISSTREAM_TLS_VERIFY_PEER', env_int('AISSTREAM_TLS_VERIFY_PEER', 1) === 1);
